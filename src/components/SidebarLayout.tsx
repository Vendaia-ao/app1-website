...
export default function SidebarLayout({ title, heroImageUrl, items, basePath, children }: SidebarLayoutProps) {
  return (
    <div className="w-full flex flex-col min-h-screen">
      {/* Hero Section */}
      <div className="w-full h-[250px] md:h-[300px] bg-isec-dark-gray flex items-center justify-center relative overflow-hidden shrink-0">
        {heroImageUrl && (
          <img 
            src={heroImageUrl} 
            alt={title} 
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-white relative z-10 drop-shadow-md text-center px-4">
          {title}
        </h1>
      </div>
